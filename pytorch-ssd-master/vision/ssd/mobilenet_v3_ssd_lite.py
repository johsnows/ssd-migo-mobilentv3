...
def create_mobilenetv3_ssd_lite_large(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False):
    ...
    regression_headers = ModuleList([
        SeperableConv2d(in_channels=round(672 * width_mult), out_channels=6 * 4,
    ...
    classification_headers = ModuleList([
        SeperableConv2d(in_channels=round(672 * width_mult), out_channels=6 * num_classes, kernel_size=3, padding=1),
...
def create_mobilenetv3_ssd_lite_small(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False):
